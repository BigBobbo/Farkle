...
eq(scoreSelection([3,3,3,5,5,5]), 800, 'two triplets scores additively (300+500)');
eq(scoreSelection([2,2,2,4,4,4]), 600, 'two triplets 2s+4s = 200+400');
eq(scoreSelection([1,1,1,6,6,6]), 1600, 'two triplets 1s+6s = 1000+600');
